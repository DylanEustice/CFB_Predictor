...
namespace CFB_Predictor
{
    public partial class Program
    {
        ...
        public const double MIN_WEIGHT      = -0.5;       // min initial weight of neural network synapse
        ...
        {
            // New season
            Season trainSeason1 = new Season(2012);
            Season trainSeason2 = new Season(2013);
            Season accSeason = new Season(2013);

            //Game[] trainGames = trainSeason.Games;
            //Game[] accGames = accSeason.Games;

            Game[] trainGames1 = GetGoodGames(trainSeason1, ALL_DATES);
            Game[] trainGames2 = GetGoodGames(trainSeason2, TRAIN_DATES);
            ...
            Game[] accGames = GetGoodGames(accSeason, ALL_DATES);
